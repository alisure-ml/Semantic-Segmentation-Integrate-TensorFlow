...
from TrainRefineNet import TrainRefineNet
from TestRefineNet import TestRefineNet
from ValRefineNet import ValRefineNet
...
class Main(object):
    ...
    def __init__(self, name, class_list, input_size, pre_train, sub_mean, batch_size_list, number_classes,
        ...
        if run_type == 1:
            ...
            self.data = DataVOC2012Val(data_file="data/VOC2012/val.tfrecord", number_classes=number_classes,
                                       input_size=input_size, batch_size=batch_size_list[1], sub_mean=sub_mean)
            ...
            self.data = DataVOC2012Test(data_file=record_dir, number_classes=number_classes,
                                        input_size=input_size, batch_size=batch_size_list[2], sub_mean=sub_mean)
...
if __name__ == '__main__':
    ...
    #             batch_size_list=list([1, 2, 1]), pre_train=None,
    #             number_classes=21, total_step=10000, save_freq=100, run_type=1,
