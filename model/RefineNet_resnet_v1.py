...
import RefineNet_resnet_utils as resnet_utils
...
def resnet_v1(inputs, blocks, num_classes=None, is_training=True, global_pool=True,
              output_stride=None, include_root_block=True, spatial_squeeze=True, reuse=None, scope=None):
...
def resnet_v1_101(inputs, num_classes=None, is_training=True, global_pool=True,
